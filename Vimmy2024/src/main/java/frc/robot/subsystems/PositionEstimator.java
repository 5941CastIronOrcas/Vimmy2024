...
public class PositionEstimator extends SubsystemBase {
  ...
  public static Transform3d robotToCam1 = new Transform3d(new Translation3d(0, -0.32, 0.34), new Rotation3d(0,0,0));
  public static Transform3d robotToCam2 = new Transform3d(new Translation3d(0, 0.32, 0.34), new Rotation3d(0,0,0));
